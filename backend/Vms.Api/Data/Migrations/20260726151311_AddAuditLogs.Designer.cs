...
namespace Vms.Api.Data.Migrations
{
    ...
    [Migration("20260726151311_AddAuditLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vms.Api.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Vms.Api.Domain.Entities.RecordingKeyframe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RecordingId", "TimestampSeconds")
                        .IsUnique();

                    b.ToTable("RecordingKeyframes");
                });
            ...
            modelBuilder.Entity("Vms.Api.Domain.Entities.RecordingKeyframe", b =>
                {
                    b.HasOne("Vms.Api.Domain.Entities.Recording", "Recording")
                        .WithMany("Keyframes")
