...
| 2. Authentication, roles, and assignments | Completed and verified | JWT sessions, secure hashes, three roles, persisted Viewer assignments, login/logout events, protected React routes, 8 backend tests, 3 frontend tests, live verification script, HTML guide |
...
- `dotnet test Vms.slnx`: 8 passed; frontend tests: 3 passed.
