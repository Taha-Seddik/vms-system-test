...
| 2. Authentication, roles, and assignments | Completed and verified | Layered backend, JWT sessions, secure hashes, three roles, persisted Viewer assignments, login/logout events, protected React routes, 11 backend tests, 3 frontend tests, live verification script, HTML guide |
...
- `dotnet test Vms.slnx`: 11 passed; frontend tests: 3 passed.
